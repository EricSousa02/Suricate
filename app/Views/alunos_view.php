...
<div class="container mt-3">
  <h3 class="text-center titulo">ALUNOS</h3>
  <nav class="navbar navbar-example navbar-expand-lg ">



    <div class="navbar-collapse d-flex" id="navbar-ex-4 ">
  ...
  <?php if (count($alunos) == 0) : ?>
    ...
    <p class="text-center">Não existem alunos.</p>

  <?php else : ?>
    <div class="card table-responsive text-nowrap">

    <table class="table table-striped table-hover">
      <thead style="background: linear-gradient(#26a96c,#32936f);">
        <tr>
        ...
        <?php foreach ($alunos as $row) : ?>
          <tr class="lista">
            ...
            <td>
              ...
              <a href="#"  data-toggle="tooltip" title="Editar" class="btn btn-info btn-sm btn-edit " style="margin: 2px;" data-id="<?= $row->id; ?>" data-nome="<?= $row->nome; ?>" data-email="<?= $row->email; ?>" data-senha="<?= $row->senha; ?>" data-turma="<?= $row->turma; ?>"><i class="fa-solid fa-pen"></i></a>
...
<!-- Modal Add Product-->
<form action="<?= base_url('/product/saveAlunos') ?>" method="post">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Nome</label>
            <input type="text" class="form-control" name="nome" placeholder="Nome do aluno" required>
          </div>
          ...
          <div class="form-group mt-3">
            <label>E-mail</label>
            <input type="email" class="form-control" name="email" placeholder="E-mail do aluno" required>
          </div>
          ...
          <div class="form-group mt-3">
            <label>Senha</label>
            <input type="password" class="form-control" name="senha" placeholder="Senha do aluno" required>
          </div>
...
<!-- Modal Edit Product-->
<form action="<?= base_url('/product/updateAlunos') ?>" method="post">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Nome</label>
            <input type="text" class="form-control nome" name="nome" placeholder="Nome do aluno" required>
          </div>
          ...
          <div class="form-group mt-3">
            <label>E-mail</label>
            <input type="email" class="form-control email" name="email" placeholder="E-mail do aluno" required>
          </div>


          <div class="mt-3">
            <label for="exampleFormControlSelect1">Turma</label>
            <select class="form-select turma" id="exampleFormControlSelect1" required name="turma" aria-label="Default select example">
              <option value="" style="background: #B2B2B2; color: #3C4048;">-Selecione a turma-</option>
              <option value="1° Ano - Turma A">1° Ano - Turma A</option>
              <option value="1° Ano - Turma B">1° Ano - Turma B</option>
              <option value="1° Ano - Turma C">1° Ano - Turma C</option>
          ...
          <div class="form-group mt-3">
            <label>Senha</label>
            <input type="password" class="form-control senha" name="senha" placeholder="Senha do aluno" required>
          </div>
...
<form action="<?= base_url('/product/deleteAlunos') ?>" method="post">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h4>deseja mesmo excluir esse(a) estudante?</h4>
...
<div class="demo-inline-spacing">
  ...
  <script>
    ...
    alunos.classList = "menu-item active open";
