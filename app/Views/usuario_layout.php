        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item listaHome" id="home">
              <a href="<?= site_url('product/homeUsuario')?>" class="menu-link ">
      ...
      <li class="">
        <span class="menu-header-text" ></span>
         ...
         <li class="menu-item listaHome" id="justificativas">
               <a href="<?= site_url('Product/usuarios')?>" class="menu-link">
               <i class="fa-solid fa-list"></i>
                 <div data-i18n="Without navbar"  style="transform:translateX(10px);">Suas Justificativas</div>
               </a>
             </li>
        ...
        <nav
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <!-- /Search -->
              <ul class="navbar-nav flex-row align-items-center ms-auto config" id="config" style="display: block;">
              <a href="#"  class="btn btn-info btn-sm btn-editar editar" data-bs-toggle="modal" data-bs-target="#exampleModal" style="font-size: 15px;"><i class="fa-solid fa-gear gear"></i></a>
              
              </ul>

              <ul class="navbar-nav flex-row align-items-center ms-auto config" id="infoMobile" style="display: block;">
              <a href="#"  class="btn btn-primary btn-sm btn-editar infoMobile" data-bs-toggle="modal" data-bs-target="#modalInfoMobile" style="font-size: 15px;"><i class="fa-solid fa-circle-info"></i></a>
...
function searchHome() {
    ...
    document.getElementById('config').style.display = "none";
      ...
      <!-- criação da render -->
  <?= $this->renderSection('usuarios_layout') ?>
  <!-- /criação da render -->
  </body>
